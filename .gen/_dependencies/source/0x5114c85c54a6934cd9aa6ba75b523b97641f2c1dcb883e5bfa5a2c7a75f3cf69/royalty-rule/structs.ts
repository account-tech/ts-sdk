...
export function isRule(type: string): boolean { type = compressSuiType(type); return type === "0x5114c85c54a6934cd9aa6ba75b523b97641f2c1dcb883e5bfa5a2c7a75f3cf69::royalty_rule::Rule"; }

export interface RuleFields { dummyField: ToField<"bool"> }

export type RuleReified = Reified< Rule, RuleFields >;

export class Rule implements StructClass { static readonly $typeName = "0x5114c85c54a6934cd9aa6ba75b523b97641f2c1dcb883e5bfa5a2c7a75f3cf69::royalty_rule::Rule"; static readonly $numTypeParams = 0;

 readonly $typeName = Rule.$typeName;

 readonly $fullTypeName: "0x5114c85c54a6934cd9aa6ba75b523b97641f2c1dcb883e5bfa5a2c7a75f3cf69::royalty_rule::Rule";

 readonly $typeArgs: [];

 readonly dummyField: ToField<"bool">

 private constructor(typeArgs: [], fields: RuleFields, ) { this.$fullTypeName = composeSuiType( Rule.$typeName, ...typeArgs ) as "0x5114c85c54a6934cd9aa6ba75b523b97641f2c1dcb883e5bfa5a2c7a75f3cf69::royalty_rule::Rule"; this.$typeArgs = typeArgs;
...
export function isConfig(type: string): boolean { type = compressSuiType(type); return type === "0x5114c85c54a6934cd9aa6ba75b523b97641f2c1dcb883e5bfa5a2c7a75f3cf69::royalty_rule::Config"; }
...
export class Config implements StructClass { static readonly $typeName = "0x5114c85c54a6934cd9aa6ba75b523b97641f2c1dcb883e5bfa5a2c7a75f3cf69::royalty_rule::Config"; static readonly $numTypeParams = 0;

 readonly $typeName = Config.$typeName;

 readonly $fullTypeName: "0x5114c85c54a6934cd9aa6ba75b523b97641f2c1dcb883e5bfa5a2c7a75f3cf69::royalty_rule::Config";

 readonly $typeArgs: [];

 readonly amountBp: ToField<"u16">; readonly minAmount: ToField<"u64">

 private constructor(typeArgs: [], fields: ConfigFields, ) { this.$fullTypeName = composeSuiType( Config.$typeName, ...typeArgs ) as "0x5114c85c54a6934cd9aa6ba75b523b97641f2c1dcb883e5bfa5a2c7a75f3cf69::royalty_rule::Config"; this.$typeArgs = typeArgs;
