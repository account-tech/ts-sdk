...
export function isWrapper(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V27}::dynamic_object_field::Wrapper` + '<'); }
