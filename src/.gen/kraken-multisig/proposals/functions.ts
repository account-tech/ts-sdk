...
export function contains( tx: Transaction, args: ContainsArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::proposals::contains`, arguments: [ obj(tx, args.proposals), pure(tx, args.key, `${String.$typeName}`) ], }) }
...
export interface RemoveArgs { proposals: TransactionObjectInput; key: string | TransactionArgument }

export function remove( tx: Transaction, args: RemoveArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::proposals::remove`, arguments: [ obj(tx, args.proposals), pure(tx, args.key, `${String.$typeName}`) ], }) }
...
export function get( tx: Transaction, args: GetArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::proposals::get`, arguments: [ obj(tx, args.proposals), pure(tx, args.key, `${String.$typeName}`) ], }) }
...
export function getIdx( tx: Transaction, args: GetIdxArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::proposals::get_idx`, arguments: [ obj(tx, args.proposals), pure(tx, args.key, `${String.$typeName}`) ], }) }
...
export interface GetMutArgs { proposals: TransactionObjectInput; key: string | TransactionArgument }

export function getMut( tx: Transaction, args: GetMutArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::proposals::get_mut`, arguments: [ obj(tx, args.proposals), pure(tx, args.key, `${String.$typeName}`) ], }) }
...
export interface NewProposalArgs { auth: TransactionObjectInput; key: string | TransactionArgument; description: string | TransactionArgument; executionTime: bigint | TransactionArgument; expirationEpoch: bigint | TransactionArgument }

export function newProposal( tx: Transaction, args: NewProposalArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::proposals::new_proposal`, arguments: [ obj(tx, args.auth), pure(tx, args.key, `${String.$typeName}`), pure(tx, args.description, `${String.$typeName}`), pure(tx, args.executionTime, `u64`), pure(tx, args.expirationEpoch, `u64`) ], }) }
