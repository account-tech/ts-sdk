...
export interface ApprovedFields { authWitness: ToField<String>; authName: ToField<String>; key: ToField<String>; description: ToField<String> }
...
export class Approved implements StructClass { __StructClass = true as const;
 ...
 readonly authWitness: ToField<String>; readonly authName: ToField<String>; readonly key: ToField<String>; readonly description: ToField<String>
 ...
 this.authWitness = fields.authWitness;; this.authName = fields.authName;; this.key = fields.key;; this.description = fields.description; }
 ...
 auth_witness: String.bcs, auth_name: String.bcs, key: String.bcs, description: String.bcs

}) };

 static fromFields( fields: Record<string, any> ): Approved { return Approved.reified( ).new( { authWitness: decodeFromFields(String.reified(), fields.auth_witness), authName: decodeFromFields(String.reified(), fields.auth_name), key: decodeFromFields(String.reified(), fields.key), description: decodeFromFields(String.reified(), fields.description) } ) }

 static fromFieldsWithTypes( item: FieldsWithTypes ): Approved { if (!isApproved(item.type)) { throw new Error("not a Approved type");

 }

 return Approved.reified( ).new( { authWitness: decodeFromFieldsWithTypes(String.reified(), item.fields.auth_witness), authName: decodeFromFieldsWithTypes(String.reified(), item.fields.auth_name), key: decodeFromFieldsWithTypes(String.reified(), item.fields.key), description: decodeFromFieldsWithTypes(String.reified(), item.fields.description) } ) }

 static fromBcs( data: Uint8Array ): Approved { return Approved.fromFields( Approved.bcs.parse(data) ) }

 toJSONField() { return {

 authWitness: this.authWitness,authName: this.authName,key: this.key,description: this.description,

} }

 toJSON() { return { $typeName: this.$typeName, $typeArgs: this.$typeArgs, ...this.toJSONField() } }

 static fromJSONField( field: any ): Approved { return Approved.reified( ).new( { authWitness: decodeFromJSONField(String.reified(), field.authWitness), authName: decodeFromJSONField(String.reified(), field.authName), key: decodeFromJSONField(String.reified(), field.key), description: decodeFromJSONField(String.reified(), field.description) } ) }
...
export interface CreatedFields { authWitness: ToField<String>; authName: ToField<String>; key: ToField<String>; description: ToField<String> }
...
export class Created implements StructClass { __StructClass = true as const;
 ...
 static fromFields( fields: Record<string, any> ): Created { return Created.reified( ).new( { authWitness: decodeFromFields(String.reified(), fields.auth_witness), authName: decodeFromFields(String.reified(), fields.auth_name), key: decodeFromFields(String.reified(), fields.key), description: decodeFromFields(String.reified(), fields.description) } ) }

 static fromFieldsWithTypes( item: FieldsWithTypes ): Created { if (!isCreated(item.type)) { throw new Error("not a Created type");

 }

 return Created.reified( ).new( { authWitness: decodeFromFieldsWithTypes(String.reified(), item.fields.auth_witness), authName: decodeFromFieldsWithTypes(String.reified(), item.fields.auth_name), key: decodeFromFieldsWithTypes(String.reified(), item.fields.key), description: decodeFromFieldsWithTypes(String.reified(), item.fields.description) } ) }
 ...
 static fromJSONField( field: any ): Created { return Created.reified( ).new( { authWitness: decodeFromJSONField(String.reified(), field.authWitness), authName: decodeFromJSONField(String.reified(), field.authName), key: decodeFromJSONField(String.reified(), field.key), description: decodeFromJSONField(String.reified(), field.description) } ) }
...
export interface ExecutedFields { authWitness: ToField<String>; authName: ToField<String>; key: ToField<String>; description: ToField<String> }
...
export class Executed implements StructClass { __StructClass = true as const;
 ...
 static fromFields( fields: Record<string, any> ): Executed { return Executed.reified( ).new( { authWitness: decodeFromFields(String.reified(), fields.auth_witness), authName: decodeFromFields(String.reified(), fields.auth_name), key: decodeFromFields(String.reified(), fields.key), description: decodeFromFields(String.reified(), fields.description) } ) }

 static fromFieldsWithTypes( item: FieldsWithTypes ): Executed { if (!isExecuted(item.type)) { throw new Error("not a Executed type");

 }

 return Executed.reified( ).new( { authWitness: decodeFromFieldsWithTypes(String.reified(), item.fields.auth_witness), authName: decodeFromFieldsWithTypes(String.reified(), item.fields.auth_name), key: decodeFromFieldsWithTypes(String.reified(), item.fields.key), description: decodeFromFieldsWithTypes(String.reified(), item.fields.description) } ) }
 ...
 static fromJSONField( field: any ): Executed { return Executed.reified( ).new( { authWitness: decodeFromJSONField(String.reified(), field.authWitness), authName: decodeFromJSONField(String.reified(), field.authName), key: decodeFromJSONField(String.reified(), field.key), description: decodeFromJSONField(String.reified(), field.description) } ) }
...
export interface ProposalFields { auth: ToField<Auth>; key: ToField<String>; description: ToField<String>; expirationEpoch: ToField<"u64">; executionTime: ToField<"u64">; actions: ToField<Bag>; totalWeight: ToField<"u64">; roleWeight: ToField<"u64">; approved: ToField<VecSet<"address">> }
...
export class Proposal implements StructClass { __StructClass = true as const;
 ...
 readonly auth: ToField<Auth>; readonly key: ToField<String>; readonly description: ToField<String>; readonly expirationEpoch: ToField<"u64">; readonly executionTime: ToField<"u64">; readonly actions: ToField<Bag>; readonly totalWeight: ToField<"u64">; readonly roleWeight: ToField<"u64">; readonly approved: ToField<VecSet<"address">>
 ...
 this.auth = fields.auth;; this.key = fields.key;; this.description = fields.description;; this.expirationEpoch = fields.expirationEpoch;; this.executionTime = fields.executionTime;; this.actions = fields.actions;; this.totalWeight = fields.totalWeight;; this.roleWeight = fields.roleWeight;; this.approved = fields.approved; }
 ...
 auth: Auth.bcs, key: String.bcs, description: String.bcs, expiration_epoch: bcs.u64(), execution_time: bcs.u64(), actions: Bag.bcs, total_weight: bcs.u64(), role_weight: bcs.u64(), approved: VecSet.bcs(bcs.bytes(32).transform({ input: (val: string) => fromHEX(val), output: (val: Uint8Array) => toHEX(val), }))

}) };

 static fromFields( fields: Record<string, any> ): Proposal { return Proposal.reified( ).new( { auth: decodeFromFields(Auth.reified(), fields.auth), key: decodeFromFields(String.reified(), fields.key), description: decodeFromFields(String.reified(), fields.description), expirationEpoch: decodeFromFields("u64", fields.expiration_epoch), executionTime: decodeFromFields("u64", fields.execution_time), actions: decodeFromFields(Bag.reified(), fields.actions), totalWeight: decodeFromFields("u64", fields.total_weight), roleWeight: decodeFromFields("u64", fields.role_weight), approved: decodeFromFields(VecSet.reified("address"), fields.approved) } ) }

 static fromFieldsWithTypes( item: FieldsWithTypes ): Proposal { if (!isProposal(item.type)) { throw new Error("not a Proposal type");

 }

 return Proposal.reified( ).new( { auth: decodeFromFieldsWithTypes(Auth.reified(), item.fields.auth), key: decodeFromFieldsWithTypes(String.reified(), item.fields.key), description: decodeFromFieldsWithTypes(String.reified(), item.fields.description), expirationEpoch: decodeFromFieldsWithTypes("u64", item.fields.expiration_epoch), executionTime: decodeFromFieldsWithTypes("u64", item.fields.execution_time), actions: decodeFromFieldsWithTypes(Bag.reified(), item.fields.actions), totalWeight: decodeFromFieldsWithTypes("u64", item.fields.total_weight), roleWeight: decodeFromFieldsWithTypes("u64", item.fields.role_weight), approved: decodeFromFieldsWithTypes(VecSet.reified("address"), item.fields.approved) } ) }

 static fromBcs( data: Uint8Array ): Proposal { return Proposal.fromFields( Proposal.bcs.parse(data) ) }

 toJSONField() { return {

 auth: this.auth.toJSONField(),key: this.key,description: this.description,expirationEpoch: this.expirationEpoch.toString(),executionTime: this.executionTime.toString(),actions: this.actions.toJSONField(),totalWeight: this.totalWeight.toString(),roleWeight: this.roleWeight.toString(),approved: this.approved.toJSONField(),

} }

 toJSON() { return { $typeName: this.$typeName, $typeArgs: this.$typeArgs, ...this.toJSONField() } }

 static fromJSONField( field: any ): Proposal { return Proposal.reified( ).new( { auth: decodeFromJSONField(Auth.reified(), field.auth), key: decodeFromJSONField(String.reified(), field.key), description: decodeFromJSONField(String.reified(), field.description), expirationEpoch: decodeFromJSONField("u64", field.expirationEpoch), executionTime: decodeFromJSONField("u64", field.executionTime), actions: decodeFromJSONField(Bag.reified(), field.actions), totalWeight: decodeFromJSONField("u64", field.totalWeight), roleWeight: decodeFromJSONField("u64", field.roleWeight), approved: decodeFromJSONField(VecSet.reified("address"), field.approved) } ) }
