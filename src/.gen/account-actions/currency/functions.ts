...
export interface ProposeTransferArgs { auth: TransactionObjectInput; account: TransactionObjectInput; outcome: GenericArg; key: string | TransactionArgument; description: string | TransactionArgument; executionTime: bigint | TransactionArgument; expirationTime: bigint | TransactionArgument; amounts: Array<bigint | TransactionArgument> | TransactionArgument; recipients: Array<string | TransactionArgument> | TransactionArgument }

export function proposeTransfer( tx: Transaction, typeArgs: [string, string, string], args: ProposeTransferArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::currency::propose_transfer`, typeArguments: typeArgs, arguments: [ obj(tx, args.auth), obj(tx, args.account), generic(tx, `${typeArgs[1]}`, args.outcome), pure(tx, args.key, `${String.$typeName}`), pure(tx, args.description, `${String.$typeName}`), pure(tx, args.executionTime, `u64`), pure(tx, args.expirationTime, `u64`), pure(tx, args.amounts, `vector<u64>`), pure(tx, args.recipients, `vector<address>`) ], }) }

export interface ProposeVestingArgs { auth: TransactionObjectInput; account: TransactionObjectInput; outcome: GenericArg; key: string | TransactionArgument; description: string | TransactionArgument; executionTime: bigint | TransactionArgument; expirationTime: bigint | TransactionArgument; totalAmount: bigint | TransactionArgument; startTimestamp: bigint | TransactionArgument; endTimestamp: bigint | TransactionArgument; recipient: string | TransactionArgument }

export function proposeVesting( tx: Transaction, typeArgs: [string, string, string], args: ProposeVestingArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::currency::propose_vesting`, typeArguments: typeArgs, arguments: [ obj(tx, args.auth), obj(tx, args.account), generic(tx, `${typeArgs[1]}`, args.outcome), pure(tx, args.key, `${String.$typeName}`), pure(tx, args.description, `${String.$typeName}`), pure(tx, args.executionTime, `u64`), pure(tx, args.expirationTime, `u64`), pure(tx, args.totalAmount, `u64`), pure(tx, args.startTimestamp, `u64`), pure(tx, args.endTimestamp, `u64`), pure(tx, args.recipient, `address`) ], }) }
...
export interface ProposeBurnArgs { auth: TransactionObjectInput; account: TransactionObjectInput; outcome: GenericArg; key: string | TransactionArgument; description: string | TransactionArgument; executionTime: bigint | TransactionArgument; expirationTime: bigint | TransactionArgument; coinId: string | TransactionArgument; amount: bigint | TransactionArgument }

export function proposeBurn( tx: Transaction, typeArgs: [string, string, string], args: ProposeBurnArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::currency::propose_burn`, typeArguments: typeArgs, arguments: [ obj(tx, args.auth), obj(tx, args.account), generic(tx, `${typeArgs[1]}`, args.outcome), pure(tx, args.key, `${String.$typeName}`), pure(tx, args.description, `${String.$typeName}`), pure(tx, args.executionTime, `u64`), pure(tx, args.expirationTime, `u64`), pure(tx, args.coinId, `${ID.$typeName}`), pure(tx, args.amount, `u64`) ], }) }

export interface ProposeDisableArgs { auth: TransactionObjectInput; account: TransactionObjectInput; outcome: GenericArg; key: string | TransactionArgument; description: string | TransactionArgument; executionTime: bigint | TransactionArgument; expirationTime: bigint | TransactionArgument; disableMint: boolean | TransactionArgument; disableBurn: boolean | TransactionArgument; disableUpdateSymbol: boolean | TransactionArgument; disableUpdateName: boolean | TransactionArgument; disableUpdateDescription: boolean | TransactionArgument; disableUpdateIcon: boolean | TransactionArgument }

export function proposeDisable( tx: Transaction, typeArgs: [string, string, string], args: ProposeDisableArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::currency::propose_disable`, typeArguments: typeArgs, arguments: [ obj(tx, args.auth), obj(tx, args.account), generic(tx, `${typeArgs[1]}`, args.outcome), pure(tx, args.key, `${String.$typeName}`), pure(tx, args.description, `${String.$typeName}`), pure(tx, args.executionTime, `u64`), pure(tx, args.expirationTime, `u64`), pure(tx, args.disableMint, `bool`), pure(tx, args.disableBurn, `bool`), pure(tx, args.disableUpdateSymbol, `bool`), pure(tx, args.disableUpdateName, `bool`), pure(tx, args.disableUpdateDescription, `bool`), pure(tx, args.disableUpdateIcon, `bool`) ], }) }

export interface ProposeMintArgs { auth: TransactionObjectInput; account: TransactionObjectInput; outcome: GenericArg; key: string | TransactionArgument; description: string | TransactionArgument; executionTime: bigint | TransactionArgument; expirationTime: bigint | TransactionArgument; amount: bigint | TransactionArgument }

export function proposeMint( tx: Transaction, typeArgs: [string, string, string], args: ProposeMintArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::currency::propose_mint`, typeArguments: typeArgs, arguments: [ obj(tx, args.auth), obj(tx, args.account), generic(tx, `${typeArgs[1]}`, args.outcome), pure(tx, args.key, `${String.$typeName}`), pure(tx, args.description, `${String.$typeName}`), pure(tx, args.executionTime, `u64`), pure(tx, args.expirationTime, `u64`), pure(tx, args.amount, `u64`) ], }) }

export interface ProposeUpdateArgs { auth: TransactionObjectInput; account: TransactionObjectInput; outcome: GenericArg; key: string | TransactionArgument; description: string | TransactionArgument; executionTime: bigint | TransactionArgument; expirationTime: bigint | TransactionArgument; mdSymbol: (string | TransactionArgument | TransactionArgument | null); mdName: (string | TransactionArgument | TransactionArgument | null); mdDescription: (string | TransactionArgument | TransactionArgument | null); mdIcon: (string | TransactionArgument | TransactionArgument | null) }

export function proposeUpdate( tx: Transaction, typeArgs: [string, string, string], args: ProposeUpdateArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::currency::propose_update`, typeArguments: typeArgs, arguments: [ obj(tx, args.auth), obj(tx, args.account), generic(tx, `${typeArgs[1]}`, args.outcome), pure(tx, args.key, `${String.$typeName}`), pure(tx, args.description, `${String.$typeName}`), pure(tx, args.executionTime, `u64`), pure(tx, args.expirationTime, `u64`), pure(tx, args.mdSymbol, `${Option.$typeName}<${String1.$typeName}>`), pure(tx, args.mdName, `${Option.$typeName}<${String.$typeName}>`), pure(tx, args.mdDescription, `${Option.$typeName}<${String.$typeName}>`), pure(tx, args.mdIcon, `${Option.$typeName}<${String1.$typeName}>`) ], }) }
